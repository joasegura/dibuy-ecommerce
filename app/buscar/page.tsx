      ...
      <section className="bg-gradient-primary text-white py-12">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h1 className="text-3xl md:text-4xl font-bold mb-4">Buscar productos</h1>
            <p className="text-lg opacity-90">Encuentra exactamente lo que necesitas</p>
          </div>
        </div>
      </section>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm space-y-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {["all", "smartphones", "laptops", "tablets", "accesorios", "gaming"].map((category) => (
                    <label key={category} className="flex items-center space-x-2">
                      ...
                      />
                      <span className="capitalize">{category === "all" ? "Todas las categorías" : category}</span>
                    </label>
                  ))}
                </div>
              </div>
                  ...
                  {["all", ...brands].map((brand) => (
                    <label key={brand} className="flex items-center space-x-2">
                      <input
                        ...
                        className="text-primary"
                      />
                      <span>{brand === "all" ? "Todas las marcas" : brand}</span>
                    </label>
                  ))}
                </div>
              </div>
